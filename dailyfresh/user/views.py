...
class OrderView(LoginRequiredMixin, View):
    def get(self, request,page):
        ...
        return render(request, 'user/user_center_order.html', {'order_page':order_page,'page': 2,'pages':pages})
...
class InfoView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        goodskus = [GoodsSKU.objects.get(id = i) for i in history]
        return render(request, 'user/user_center_info.html', {'page': 1,'goodskus':goodskus})
    def post(self,request):
